...
<head>
    ...
    <style>
        /* H5：Flow Board 移动端适配，仅调整布局与视觉，不改逻辑 */
        @media (max-width: 768px) {
            ...
            #flb_selectors .jumbotron {
                padding: 1rem !important;
                margin-bottom: 0.75rem;
            }

            /* 顶部筛选区域：三列在手机上改为上下堆叠 */
            #flb_selectors .flb-filters-row > div {
                margin-bottom: 0.75rem;
            }

            #flb_selectors select.form-control-sm,
            #flb_selectors input.form-control-sm {
                font-size: 0.9rem;
            }

            /* 日期区标签与输入更紧凑 */
            #flb_selectors .flb-dates .col-form-label {
                padding-top: 0.25rem;
            ...
            <div class="jumbotron p-4">
                <div class="showRFlow text-center" id="show_flows" name="kiosk_hide">
                    <div name="div_response" id="div_response" class="nodisplay"></div>
                        ...
                        <div class="row flb-filters-row">
                          <input type="hidden" name="csrf_token_form" value="<?php echo attr(CsrfUtils::collectCsrfToken()); ?>" />
                            <div class="text-center col-12 col-md-4 align-items-center mb-3 mb-md-0">
                            ...
                            <div class="col-12 col-md-4 mt-3 row flb-dates" style="<?php echo $style; ?>">
                            ...
                            <div class="col-12 col-md-4 mt-3 row">
