...
function viewPtFinder(myMessage, searchAnyType, data, event)
{
    ...
    let finderUrl = webroot_url+"/interface/mobile/main/finder/dynamic_finder.php";
...
{
    navigateTab(webroot_url+"/interface/mobile/main/messages/messages.php?form_active=1","msg", function () {
