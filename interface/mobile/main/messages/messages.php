...
<head>
    ...
    <style>
        ...
        @media only screen and (max-width: 768px) {
            ...
            .d-flex.justify-content-around h4 {
                margin-bottom: 0.5rem;
                font-size: 1.1rem;
            }

            .d-flex.justify-content-around .nav {
                flex-direction: row;
                flex-wrap: wrap;
                gap: 0.5rem;
            ...
            .d-flex.justify-content-around .nav-item {
                margin-bottom: 0.25rem;
            }

            .d-flex.justify-content-around .nav-link {
            ...
            .oe-custom-line .row > [class*="col-"] {
                margin-bottom: 0.75rem;
            }

            .oe-custom-line label {
                font-size: 0.9rem;
                margin-bottom: 0.25rem;
            }
...
<body class='body_top'>
    <div id="container_div" class="<?php echo attr($oemr_ui->oeContainer()); ?>">
        ...
        <div class="row my-2 my-md-3">
            <div class="col-12">
                <ul class="nav nav-pills bg-light flex-nowrap" id="main-nav-pills" role="tablist">
        ...
        <div class="tab-content" id="content">
            <div class="row tab-pane active" role="tabpanel" id="messages-div">
                <div class="col-sm-12">
                    ...
                    if ($task == "addnew" or $task == "edit") {
                        ...
                        ?>
                        <div class='col-12'>
                            <div class="jumbotron jumbotron-fluid p-2 p-md-3">
                                <h4 class="mb-3"><?php echo text($message_legend); ?></h4>
                                <div class="row">
                                    <div class="col-12 oe-custom-line">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-12 col-lg-3 d-flex align-items-end mb-2">
                                                <?php
                                                if ($task == "addnew" || $result['pid'] == 0) {
                                                    echo '<button type="button" id="clear_patients"  class="btn btn-secondary btn-undo w-100" value="' . xla('Clear') . '">' . xlt("Clear") . '</button>';
                                                } ?>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12 oe-custom-line">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6 col-lg-4 mb-2">
                                                <label for="users"><?php echo xlt('Select User'); ?>:</label>
                                            ...
                                            <div class="col-12 col-md-6 col-lg-4 mb-2 d-flex align-items-end">
                                                <button type="button" name="clear_user" id="clear_user" class="btn btn-secondary btn-undo w-100" value="<?php echo xla('Clear'); ?>"><?php echo xlt('Clear'); ?></button>
                                            </div>
                                        </div>
                                ...
                                <!-- <div class="row"> -->
                                    ...
                                    <div class="col-12 d-flex flex-column flex-md-row gap-2 mt-3">
                                        <?php if ($noteid) { ?>
                                            ...
                                            <button type="button" class="btn btn-primary btn-send-msg flex-fill" id="newnote" value="<?php echo xla('Send message'); ?>"><?php echo xlt('Send message'); ?></button>
                                            <button type="button" class="btn btn-primary btn-print flex-fill" id="printnote" value="<?php echo xla('Print message'); ?>"><?php echo xlt('Print message'); ?></button>
                                            <button type="button" class="btn btn-secondary btn-cancel flex-fill" id="cancel" value="<?php echo xla('Cancel'); ?>"><?php echo xlt('Cancel'); ?></button>
                                        <?php } else { ?>
                                            <!-- This is for displaying a new note. -->
                                            <button type="button" class="btn btn-primary btn-send-msg flex-fill" id="newnote" value="<?php echo xla('Send message'); ?>"><?php echo xlt('Send message'); ?></button>
                                            <button type="button" class="btn btn-cancel btn-secondary flex-fill" id="cancel" value="<?php echo xla('Cancel'); ?>"><?php echo xlt('Cancel'); ?></button>
                                        <?php }
                                        ?>
                                    </div>
                                <!-- </div> -->
                        ...
                        echo "  </table>
                                        ...
                                        <div class='d-flex flex-column flex-md-row flex-wrap gap-2 mt-3 mb-3'>
                                            <a href=\"messages.php?showall=" . attr_url($showall) . "&sortby=" . attr_url($sortby) . "&sortorder=" . attr_url($sortorder) . "&begin=" . attr_url($begin) . "&task=addnew&$activity_string_html\" class=\"btn btn-primary btn-add\" onclick=\"top.restoreSession()\">" .
                                            xlt('Add New{{Message}}') . "</a>
                                            <a href=\"javascript:confirmDeleteSelected()\" class=\"btn btn-danger btn-delete\" onclick=\"top.restoreSession()\">" .
                                            xlt('Delete') . "</a>";
                        ...
                        echo "
                                        ...
                                        <div class=\"d-flex justify-content-center align-items-center mt-2 mb-3\">
                                            <span>$prevlink &nbsp; " . text($end) . " " . xlt('of') . " " . text($total) . " &nbsp; $nextlink</span>
                                        </div>
                                    </td>
                                </tr>
                            </table>
            ...
            <div class="row tab-pane" role="tabpanel" id="recalls-div">
                <div class="col-12">
                    <h4 class="mb-3"><?php echo xlt('Recalls'); ?></h4>
                    <div class="d-flex flex-column flex-md-row gap-2">
                        <button class="btn btn-primary btn-add flex-fill" onclick="goReminderRecall('addRecall');"><?php echo xlt('New Recall'); ?></button>
                        <a class="btn btn-secondary btn-transmit flex-fill" onclick="goReminderRecall('Recalls');"><span><?php echo xlt('Recall Board'); ?></span></a>
                    </div>
                </div>
            ...
            <div class="row tab-pane" role="tabpanel" id="sms-div">
                <div class="col-12">
                    <?php if ($logged_in) { ?>
                    <h4 class="mb-3"><?php echo xlt('SMS Zone'); ?></h4>
                    <form id="smsForm" class="d-flex flex-column flex-md-row gap-2">
                        <select id="SMS_patient" type="text" class="form-control flex-fill" placeholder="<?php echo xla("Patient Name"); ?>"></select>
                        <button type="button" class="btn btn-primary" onclick="SMS_direct();" style="min-width: 60px;">
                            <i id='open-sms-tooltip' class="fas fa-phone"></i>
                        </button>
